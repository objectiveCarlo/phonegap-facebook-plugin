...
{    
    ...
    if([permissions count] >0){
        NSMutableArray *newPermissions = [NSMutableArray new];
        for(NSString* permit in permissions){
            NSString *trimmed = [permit stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]];
            [newPermissions addObject:trimmed];
        }
        permissions = [NSArray arrayWithArray:newPermissions];
    }
